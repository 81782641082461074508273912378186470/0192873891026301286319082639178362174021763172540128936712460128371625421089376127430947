...
const Page = () => {
  ...
  return (
    <div className="flex flex-col items-center w-full h-screen pt-24 max-w-screen-xl justify-center text-white border-x-[1px] border-b-[1px] px-10 xl:p-0  border-white/10">
