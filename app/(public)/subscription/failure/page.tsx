  ...
  return (
    <div className="w-full flex flex-col items-center justify-center max-w-lg mx-auto">
      <div className="w-full bg-dark-800/40 border-[1px] border-white/10 rounded-lg p-8 shadow-lg backdrop-blur-sm">
        ...
        {/* What to do */}
        <div className="mb-8">
          <h3 className="font-bold mb-2 border-b border-white/10 pb-1">Apa yang Dapat Dilakukan?</h3>
          <ul className="space-y-2 text-sm text-white/80 list-disc pl-5">
        ...
        <div className="flex flex-col space-y-3">
          ...
          <button
            onClick={() => window.location.href = 'mailto:support@autolaku.com?subject=Payment%20Failed&body=Transaction%20ID:%20' + transactionId}
